...
public class AuthController {
    ...
    public ResponseEntity<SignUpResponse> signUp(@RequestBody @Valid SignUpRequest signUpRequest) {
        ...
        return ResponseEntity
                .ok()
                .body(SignUpResponse.of(AuthConstants.SIGNUP_SUCCESS_MESSAGE, signUpRequest.getUsername()));
    }
    ...
    public ResponseEntity<LoginResponse> login(
        ...
        LoginResponse loginResponse = memberService.authenticate(loginRequest);
    ...
    public ResponseEntity<?> logout(HttpServletResponse response) {
        ...
        // 쿠키 무효화
        Cookie cookie = cookieUtils.deleteCookie(AuthConstants.ACCESS_TOKEN);
